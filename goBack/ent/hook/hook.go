...
// The TN_BBSFunc type is an adapter to allow the use of ordinary
// function as TN_BBS mutator.
type TN_BBSFunc func(context.Context, *ent.TNBBSMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TN_BBSFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TNBBSMutation); ok {
		return f(ctx, mv)
	}
